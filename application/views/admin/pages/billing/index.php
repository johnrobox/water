          ...
          <table class="table table-bordered table-hover">
              ...
              <tr>
                  ...
                  <td class="text-center">
                      ...
                      <?php $this->db->where('customer_reading_date', $this->session->userdata('setBillingMonthValue').'-'.$this->session->userdata('setBillingYear')); ?>
                      <?php $query = $this->db->get('customer_reading');?>
                      <?php if ($query->num_rows() > 0) { ?>
                        <?php $amount = $query->row(); ?>
                        <?php $readingAmount = $amount->customer_reading_amount;?>
                        <?php $readingId = $amount->id;?>
                        <?php echo number_format($readingAmount, 2); ?>
                      <?php } else { ?>
                      <?php $readingAmount = 0; ?> 
                      <?php $readingId = 0; ?>
                      <?php } ?>
